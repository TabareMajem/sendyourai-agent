...
//       // Assuming 'entry' is part of the response from Epic, update the mapping:
...
//     try {
//       // Cancel in Epic
//       await this.epicClient.makeRequest(`/api/FHIR/R4/Appointment/${appointmentId}`, {
//         method: 'PATCH',
//         body: JSON.stringify({
...
//       // Update FHIR record
//       await this.fhirClient.makeRequest(`/Appointment/${appointmentId}`, {
//         method: 'PATCH',
//         body: JSON.stringify({
//           resourceType: 'Appointment',
//           status: 'cancelled'
...
//       const existingAppointment = await this.epicClient.res(
